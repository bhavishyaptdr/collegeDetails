...
const BBAModel = ({ onClose }) => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [selectedSpecialization, setSelectedSpecialization] = useState(null);

  const specializations = [
    { name: "Not Decided Yet", icon: "/ndyet.svg" },
    { name: "General Management", icon: "/ug-icon.png" },
    { name: "Human Resource Management", icon: "/ug-icon.png" },
    { name: "Marketing", icon: "/ug-icon.png" },
    { name: "Finance & Accounting", icon: "/ug-icon.png" },
    { name: "Digital Marketing", icon: "/ug-icon.png" },
    { name: "Entrepreneurship Management & Family Business", icon: "/ug-icon.png" },
    { name: "Data Analytics", icon: "/ug-icon.png" },
    { name: "Retail and E-Commerce", icon: "/ug-icon.png" },
  ];
