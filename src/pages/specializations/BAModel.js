...
import UniversityComparisonModal from "./UniversityComparisonModal"; // Import the comparison modal

const BAModel = ({ onClose, onSelectSpecialization }) => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [selectedSpecialization, setSelectedSpecialization] = useState(null);

  const specializations = [
    { name: "Not Decided Yet", icon: "/ndyet.svg" },
    { name: "Journalism and Mass Communication", icon: "/MA_JMC.svg" },
  ];
