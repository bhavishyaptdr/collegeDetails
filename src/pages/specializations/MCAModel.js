...
const MCAModel = ({ onClose, onSelectSpecialization }) => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [selectedSpecialization, setSelectedSpecialization] = useState(null);

  const specializations = [
    { name: "Not Decided Yet", icon: "/ndyet.svg" },
    { name: "Computer Science and IT", icon: "/cyber-security.png" },
    { name: "General", icon: "/pg-icon.png" },
    { name: "Cloud Computing", icon: "/Cloud_Computing.svg" },
    { name: "Cyber Security", icon: "/cyber-security.png" },
    { name: "AI and Data Science", icon: "/cyber-security.png" },
    { name: "Data Science", icon: "/cyber-security.png" },
    { name: "Emerging Technologies", icon: "/Emergency_technology.svg" },
  ];
