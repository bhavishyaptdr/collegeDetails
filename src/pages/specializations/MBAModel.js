...
const MBAModel = ({ onClose, onSelectSpecialization }) => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [selectedSpecialization, setSelectedSpecialization] = useState(null);

  const specializations = [
    { name: "Not Decided Yet", icon: "/ndyet.svg" },
    { name: "Finance Management", icon: "/Finance_managment.svg" },
    { name: "Marketing Management", icon: "/Marketing_Managment.svg" },
    { name: "HR Management", icon: "/HR_managment.svg" },
    { name: "Operations Management", icon: "/operation_managment.svg" },
    { name: "Data Science and Analytics", icon: "/Data_science.svg" },
    { name: "Retail Management", icon: "/Retail_management.svg" },
    { name: "IT and Fintech", icon: "/IT_and_fintech.svg" },
    { name: "Banking and Insurance", icon: "/banking_insurance.svg" },
    { name: "International Business Management", icon: "/international_business.svg" },
    { name: "Information System Management", icon: "/it_managment.svg" },
    { name: "Project Management", icon: "/project_management.svg" },
    { name: "Logistics Supply Chain Management", icon: "/logistics_supply_chain.svg" },
    { name: "Banking, Financial Services & Insurance (BFSI)", icon: "/bankin_services.svg" },
    { name: "Digital Marketing", icon: "/Digital_marketing.svg" },
    { name: "Banking and Finance", icon: "/Banking-finance.svg" },
    { name: "Supply Chain Management", icon: "/supply_chain.png" },
  ];
